...
#
#   Original code from https://github.com/TomBrlek/PicoUSB
...
#Comment the needed section out. Theres two options one for the PICOUSB and one for an normal raspberry pi pico.
#mode = digitalio.DigitalInOut(board.GP25) #This is for the PICOUSB
mode = digitalio.DigitalInOut(board.GP16) #This is for the Raspberry pi pico
